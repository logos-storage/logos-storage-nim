...
proc writeWantBlocksResponse*(
  ...
  trace "Sending WantBlocks response", peer = conn.peerId, treeCid = treeCid, blockCount = blocks.len, totalDataSize = totalDataSize
  await conn.write(buf)
  trace "WantBlocks response sent", peer = conn.peerId, treeCid = treeCid, blockCount = blocks.len, totalDataSize = totalDataSize
